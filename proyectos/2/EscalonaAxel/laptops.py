...
def Unir_TarjetaMadre_RAMS():
    ...
    MotherBoard = MotherBoard - 1
    #se restan los componentes independientes despues de protegerlos. 
    RAM = RAM - 2   
...
#Para observar los diferentes procesos en ejecucion
...
#espera la señalizacion de que esta terminado
